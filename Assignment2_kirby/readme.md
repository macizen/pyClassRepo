...
below are images of all of the possible colors and a video example of user interaction. to see it in action, you can see the vidoe linked in "visualDocumentation" or download the script and run it yourself!
